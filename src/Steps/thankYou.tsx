...
const ThankYou: React.FC = () => {
    ...
    const data: PersonalInfoState = (state as PersonalInfoState) || {
        name: "",
        email: "",
        country: "",
        phone: "",
                ...
                <div className="grid md:grid-cols-2 gap-0">
                    <div className="p-8 md:p-12 flex flex-col justify-center items-center text-center border-r border-gray-200">
                        ...
                        <p className="text-xs text-gray-500 mt-4 max-w-xs">
                            *If you don’t have the reports now, you can still say hello to confirm your number and share
                            later.
                        </p>
                    ...
                    <div className="bg-gray-50 p-8 md:p-12 text-left">
                        ...
                        <p className="text-sm text-gray-500 mt-6">
                            *This is a summary of your request. Our team will reach out to confirm the details and appointment
                            availability.
                        </p>
                    </div>
                </div>

const translations = {
    en: {
        translation: {
            brand: "Global Treatment and Tourism",
            ...
            form: {
                ...
                placeholders: {
                    ...
                    problem: "Describe The Current Medical Problem ..",
                },
                countryOptions: {
                    default: "Bangladesh",
                    thailand: "Thailand",
                ...
                termsPrefix: "By submitting the form I agree to the",
                termsLink1: "Terms of Use",
                and: "and",
                termsLink2: "Privacy Policy",
                termsSuffix: "of Global Treatment and Tourism.",
            },
            services: {
            ...
            quotes: {
                ...
                get_quote: "Get Quote",
                discover: "Discover what we offer!",
                chat: "Chat",
                items: [
                    { title: "Knee Replacement", price: "$4,000" },
                    { title: "Hip Replacement", price: "$5,500" },
                    { title: "Brain Tumor", price: "$5,000" },
                    { title: "Heart Bypass Surgery", price: "$4,500" },
                    { title: "Valve Replacement", price: "$9,500" },
                    { title: "Breast Cancer", price: "$5,000" },
                    { title: "Lung Cancer", price: "$5,500" },
                    { title: "Rhinoplasty", price: "$1,800" },
                    { title: "Breast Implants", price: "$2,750" },
                    { title: "Hair Transplant", price: "$1,400" },
                    { title: "Cervical Cancer", price: "$4,500" },
                    { title: "Hysterectomy", price: "$3,000" },
                ],
            },
            how_it_works: {
                ...
                button: "Get Started",
                steps: [
                    "Contact us, share your case details and our team will get in touch with you.",
            ...
            survey: {
                title: "Thank you. Please respond to following questions for the hospital:",
                ageLabel: "Patient’s Age or Date of Birth*",
                agePlaceholder: "Example: 30 Yrs or 29-05-1985",
                doctorLegend: "1. What kind of doctors shall we recommend you?*",
                doctorOptions: [
                    "I am looking for the cheapest option, I have a very strict budget.",
                ...
                timingLegend: "2. How soon do you plan for this treatment?*",
                timingOptions: [
                ...
                hospitalLabel: "Do you have any preferred Hospital or City?",
                hospitalPlaceholder: "Any preference for hospital or city?",
                submit: "SUBMIT"
            },
            footer: {
                addressHeading: "Bangladesh Office:",
                chinaAddressHeading: "China Office:",
                ...
                whatsapp: "WhatsApp",
                copyright: "© 2025 Global Treatment and Tourism. All Rights Reserved."
            },
        },
    },
    bn: {
        translation: {
            brand: "গ্লোবাল ট্রিটমেন্ট অ্যান্ড ট্যুরিজম",
            toggle_language: "English",
            form: {
                heading: "আমরা আপনাকে সাহায্য করতে প্রস্তুত",
                placeholders: {
                    name: "রোগীর নাম",
                    email: "ইমেইল প্রবেশ করুন",
                    phone: "আপনার ফোন নম্বর",
                    problem: "বর্তমান চিকিৎসা সমস্যার বর্ণনা দিন ..",
                },
                countryOptions: {
                    default: "বাংলাদেশ",
                    thailand: "থাইল্যান্ড",
                ...
                termsPrefix: "ফর্ম জমা দিয়ে আমি",
                termsLink1: "ব্যবহারের শর্তাবলী",
                and: "এবং",
                termsLink2: "গোপনীয়তা নীতি",
                termsSuffix: "গ্লোবাল ট্রিটমেন্ট অ্যান্ড ট্যুরিজম-এ সম্মত।",
            },
            services: {
                heading: "আমাদের সেবাগুলো প্রতিটি প্রয়োজন পূরণ করে",
                intro:
                    "আমাদের টিম থেকে একজন ডেডিকেটেড কেস ম্যানেজার আপনাকে সহায়তা করবেন। নিচে আমাদের ফ্রি সেবাগুলোর তালিকা দেখুন!",
                chatButton: "চ্যাট",
                chatNote:
                    "আমাদের সেবাগুলো একেবারে ফ্রি এবং আমাদের মাধ্যমে চিকিৎসা নিতে আপনার হাসপাতালের বিল বাড়বে না!",
                items: [
                    {
                        title: "মেডিকেল মতামত ও খরচের অনুমান",
                        description: "বিশেষজ্ঞ মতামত ও খরচের পূর্বাভাস।",
                    },
                    {
                        title: "ভ্রমণের পূর্ব পরামর্শ",
                        description: "ভ্রমণের আগে আপনার চিকিৎসা সম্পর্কে জানুন।",
                    },
                    {
                        title: "ভিসা সহায়তা",
                        description: "সম্পূর্ণ মেডিকেল ভিসা সহায়তা।",
                    },
                    {
                        title: "মুদ্রা বিনিময়",
                        description: "আপনার শহরে সহজ মুদ্রা বিনিময় সেবা।",
                    },
                    {
                        title: "দোভাষী ও অনুবাদক",
                        description: "ভাষাগত বাধা দূর করতে অভিজ্ঞ দোভাষীরা পাশে থাকবেন।",
                    },
                    {
                        title: "পরিবহন সহায়তা",
                        description: "বিনামূল্যে বিমানবন্দর পরিবহন।",
                    },
                    {
                        title: "আবাসনের ব্যবস্থা",
                        description: "হাসপাতালের কাছে এবং আপনার বাজেট ও চাহিদা অনুযায়ী।",
                    },
                    {
                        title: "ভর্তি, অ্যাপয়েন্টমেন্ট, ফার্মা কেয়ার",
                        description: "মেডিকেল ব্যবস্থাপনার সম্পূর্ণ সমন্বয়।",
                    },
                    {
                        title: "প্রাইভেট নার্সিং সেবা",
                        description: "প্রয়োজন অনুযায়ী প্রাইভেট নার্সের ব্যবস্থা।",
                    },
                ],
            },
            quotes: {
                heading: "সর্বনিম্ন খরচের নিশ্চয়তা",
                description:
                    "আমরা সর্বদা সর্বোত্তম খরচ এবং বিকল্পের জন্য দর কষাকষি করি, চিকিৎসার গুণগত মানে কোনো ছাড় ছাড়াই। আমাদের মূল্য সাধারণত কম।",
                get_quote: "কোটেশন নিন",
                discover: "আমাদের অফারগুলো দেখুন!",
                chat: "চ্যাট",
                items: [
                    { title: "হাঁটু প্রতিস্থাপন", price: "$4,000" },
                    { title: "হিপ প্রতিস্থাপন", price: "$5,500" },
                    { title: "মস্তিষ্ক টিউমার", price: "$5,000" },
                    { title: "হার্ট বাইপাস সার্জারি", price: "$4,500" },
                    { title: "ভালভ প্রতিস্থাপন", price: "$9,500" },
                    { title: "ব্রেস্ট ক্যান্সার", price: "$5,000" },
                    { title: "ফুসফুসের ক্যান্সার", price: "$5,500" },
                    { title: "রাইনোপ্লাস্টি", price: "$1,800" },
                    { title: "ব্রেস্ট ইমপ্লান্ট", price: "$2,750" },
                    { title: "হেয়ার ট্রান্সপ্লান্ট", price: "$1,400" },
                    { title: "সার্ভিকাল ক্যান্সার", price: "$4,500" },
                    { title: "হিস্টেরেকটমি", price: "$3,000" },
                ],
            },
            how_it_works: {
                heading: "কিভাবে আমরা কাজ করি?",
                button: "শুরু করুন",
                steps: [
                    "আমাদের সাথে যোগাযোগ করুন, আপনার কেসের বিস্তারিত দিন, এবং আমাদের টিম আপনাকে ফোন করবে।",
                    "৪৮ ঘণ্টার মধ্যে চিকিৎসা মতামত ও খরচের অনুমান পান।",
                    "ফ্লাইট বুক করুন, এবং আমাদের টিম এয়ারপোর্টে আপনাকে রিসিভ করবে।",
                    "চিকিৎসা নিন ও ফিরে যান। ফলো-আপের জন্য আমরা আপনার পাশে থাকি।"
                ]
            },
            faq: {
            ...
            survey: {
                title: "ধন্যবাদ। অনুগ্রহ করে হাসপাতালের জন্য নিচের প্রশ্নগুলোর উত্তর দিন:",
                ageLabel: "রোগীর বয়স বা জন্মতারিখ*",
                agePlaceholder: "উদাহরণ: ৩০ বছর বা ২৯-০৫-১৯৮৫",
                doctorLegend: "১. আমরা আপনাকে কেমন ধরনের ডাক্তার সুপারিশ করব?*",
                doctorOptions: [
                    "আমি সবচেয়ে সস্তা অপশন খুঁজছি, আমার বাজেট খুব সীমিত।",
                    "আমার বাজেট কিছুটা নমনীয়, ভালো ডাক্তার এবং সাশ্রয়ী মূল্যের অপশন খুঁজছি।",
                    "আমি সবচেয়ে ভালো ডাক্তার চাই। আমার জন্য ৫-তারকা সেবা প্রয়োজন।",
                    "অন্যান্য"
                ],
                timingLegend: "২. আপনি কখন চিকিৎসার জন্য পরিকল্পনা করছেন?*",
                timingOptions: [
                    "আমি এখনও নিশ্চিত না। হয়তো ৩–৪ মাস পরে।",
                    "আমার তারিখ ঠিক আছে। আমি শুধু উপযুক্ত ডাক্তার/মূল্য খুঁজছি।",
                    "আপনারা সঠিক ডাক্তার/মূল্য পেলে আমি আগামী ৩০–৪৫ দিনের মধ্যে যেতে পারব।",
                    "অন্যান্য"
                ],
                hospitalLabel: "আপনার পছন্দের কোনো হাসপাতাল বা শহর আছে কি?",
                hospitalPlaceholder: "কোনো হাসপাতাল বা শহরের পছন্দ থাকলে লিখুন",
                submit: "জমা দিন"
            },
            footer: {
                addressHeading: "বাংলাদেশ অফিস:",
                chinaAddressHeading: "চীন অফিস:",
                ...
                copyright: "© ২০২৫ গ্লোবাল ট্রিটমেন্ট অ্যান্ড ট্যুরিজম। সর্বস্বত্ব সংরক্ষিত।"
            },
        },
    },
};
